 ...
 * - shuffle-cities: Display a random city on the globe
 * - test-tools-notification: Trigger a tools/list_changed notification
 * - test-resources-notification: Trigger a resources/list_changed notification
 */
      ...
      try {
        ...
        return {
          content: [
            {
              type: "text",
              text: "Sent tools/list_changed notification to all connected clients.",
            },
          ],
        };
      } catch (err) {
