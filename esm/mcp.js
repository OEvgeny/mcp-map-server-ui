...
// entry/mcp.js
var MessagePortTransportBase = class {
  /**
  ...
  constructor(port) {
    ...
    this._onMessageErrorEvent = (ev) => {
      const err = ev?.data instanceof Error ? ev.data : new Error("MessagePort messageerror");
      this.onerror?.(err);
    };
  }
  /**
...
var MessagePortServerTransport = class extends MessagePortTransportBase {
  /** @param {MessagePort} port */
  constructor(port) {
    super(port);
  }
};
var MessagePortClientTransport = class extends MessagePortTransportBase {
  /** @param {MessagePort} port */
  constructor(port) {
    super(port);
  }
