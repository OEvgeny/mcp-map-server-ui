  ...
  "../node_modules/fast-uri/index.js"(exports, module) {
    ...
    function normalize(uri2, options) {
      if (typeof uri2 === "string") {
        uri2 = /** @type {T} */
        serialize(parse3(uri2, options), options);
      } else if (typeof uri2 === "object") {
        uri2 = /** @type {T} */
        parse3(serialize(uri2, options), options);
      }
      return uri2;
    }
...
function parseNativeEnumDef(def) {
  const object7 = def.values;
  const actualKeys = Object.keys(def.values).filter((key) => {
    return typeof object7[object7[key]] !== "number";
  });
  const actualValues = actualKeys.map((key) => object7[key]);
...
var TaskMetadataSchema2 = z2.object({
  ttl: z2.number().optional()
});
var RelatedTaskMetadataSchema2 = z2.object({
  taskId: z2.string()
});
var RequestMetaSchema2 = z2.looseObject({
  /**
...
var NotificationsParamsSchema2 = z2.object({
  /**
...
var ResultSchema2 = z2.looseObject({
  /**
   * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
   * for notes on _meta usage.
   */
...
var JSONRPCResultResponseSchema2 = z2.object({
  jsonrpc: z2.literal(JSONRPC_VERSION2),
  id: RequestIdSchema2,
  result: ResultSchema2
}).strict();
var isJSONRPCResultResponse = (value) => JSONRPCResultResponseSchema2.safeParse(value).success;
var ErrorCode2;
(function(ErrorCode3) {
...
var JSONRPCErrorResponseSchema2 = z2.object({
  jsonrpc: z2.literal(JSONRPC_VERSION2),
...
var isJSONRPCErrorResponse = (value) => JSONRPCErrorResponseSchema2.safeParse(value).success;
...
var JSONRPCResponseSchema2 = z2.union([JSONRPCResultResponseSchema2, JSONRPCErrorResponseSchema2]);
...
var IconsSchema2 = z2.object({
   ...
   */
  icons: z2.array(IconSchema2).optional()
});
...
var FormElicitationCapabilitySchema2 = z2.intersection(z2.object({
  applyDefaults: z2.boolean().optional()
}), z2.record(z2.string(), z2.unknown()));
var ElicitationCapabilitySchema2 = z2.preprocess((value) => {
  if (value && typeof value === "object" && !Array.isArray(value)) {
...
var ClientTasksCapabilitySchema2 = z2.looseObject({
  /**
...
var ServerTasksCapabilitySchema2 = z2.looseObject({
  /**
...
var ClientCapabilitiesSchema2 = z2.object({
   ...
   */
  experimental: z2.record(z2.string(), AssertObjectSchema2).optional(),
  /**
...
var ProgressNotificationParamsSchema2 = z2.object({
...
var TaskStatusSchema2 = z2.enum(["working", "input_required", "completed", "failed", "cancelled"]);
var TaskSchema2 = z2.object({
  taskId: z2.string(),
...
var RoleSchema2 = z2.enum(["user", "assistant"]);
var AnnotationsSchema2 = z2.object({
  /**
   * Intended audience(s) for the resource.
   */
  audience: z2.array(RoleSchema2).optional(),
  /**
...
var ResourceTemplateSchema2 = z2.object({
  ...BaseMetadataSchema2.shape,
  ...IconsSchema2.shape,
  /**
...
var ToolUseContentSchema2 = z2.object({
...
var ToolExecutionSchema2 = z2.object({
  /**
...
var ToolSchema2 = z2.object({
  ...
  inputSchema: z2.object({
    ...
    properties: z2.record(z2.string(), AssertObjectSchema2).optional(),
...
var ListChangedOptionsBaseSchema2 = z2.object({
  /**
...
var LoggingLevelSchema2 = z2.enum(["debug", "info", "notice", "warning", "error", "critical", "alert", "emergency"]);
...
var ModelPreferencesSchema2 = z2.object({
   ...
   */
  hints: z2.array(ModelHintSchema2).optional(),
  /**
...
var ToolChoiceSchema2 = z2.object({
  /**
...
var ToolResultContentSchema2 = z2.object({
...
var SamplingContentSchema2 = z2.discriminatedUnion("type", [TextContentSchema2, ImageContentSchema2, AudioContentSchema2]);
var SamplingMessageContentBlockSchema2 = z2.discriminatedUnion("type", [
  TextContentSchema2,
  ImageContentSchema2,
  AudioContentSchema2,
...
var SamplingMessageSchema2 = z2.object({
  role: RoleSchema2,
  content: z2.union([SamplingMessageContentBlockSchema2, z2.array(SamplingMessageContentBlockSchema2)]),
  /**
   * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
   * for notes on _meta usage.
   */
...
var CreateMessageRequestParamsSchema2 = TaskAugmentedRequestParamsSchema2.extend({
   ...
   */
  tools: z2.array(ToolSchema2).optional(),
  /**
...
var UntitledSingleSelectEnumSchemaSchema2 = z2.object({
  type: z2.literal("string"),
  title: z2.string().optional(),
  description: z2.string().optional(),
...
var TitledSingleSelectEnumSchemaSchema2 = z2.object({
  type: z2.literal("string"),
  title: z2.string().optional(),
  description: z2.string().optional(),
...
var LegacyTitledEnumSchemaSchema2 = z2.object({
  type: z2.literal("string"),
  title: z2.string().optional(),
  description: z2.string().optional(),
  enum: z2.array(z2.string()),
...
var SingleSelectEnumSchemaSchema2 = z2.union([UntitledSingleSelectEnumSchemaSchema2, TitledSingleSelectEnumSchemaSchema2]);
var UntitledMultiSelectEnumSchemaSchema2 = z2.object({
...
var TitledMultiSelectEnumSchemaSchema2 = z2.object({
  type: z2.literal("array"),
  title: z2.string().optional(),
  description: z2.string().optional(),
  minItems: z2.number().optional(),
...
var MultiSelectEnumSchemaSchema2 = z2.union([UntitledMultiSelectEnumSchemaSchema2, TitledMultiSelectEnumSchemaSchema2]);
var EnumSchemaSchema2 = z2.union([LegacyTitledEnumSchemaSchema2, SingleSelectEnumSchemaSchema2, MultiSelectEnumSchemaSchema2]);
var PrimitiveSchemaDefinitionSchema2 = z2.union([EnumSchemaSchema2, BooleanSchemaSchema2, StringSchemaSchema2, NumberSchemaSchema2]);
...
var ElicitRequestParamsSchema2 = z2.union([ElicitRequestFormParamsSchema2, ElicitRequestURLParamsSchema2]);
...
var COMPLETABLE_SYMBOL2 = Symbol.for("mcp.completable");
function isCompletable(schema) {
  return !!schema && typeof schema === "object" && COMPLETABLE_SYMBOL2 in schema;
}
function getCompleter(schema) {
  const meta2 = schema[COMPLETABLE_SYMBOL2];
...
var McpServer = class {
  ...
  setToolRequestHandlers() {
    ...
    this.server.assertCanSetRequestHandler(getMethodValue(ListToolsRequestSchema2));
    ...
    this.server.setRequestHandler(ListToolsRequestSchema2, () => ({
    ...
    this.server.setRequestHandler(CallToolRequestSchema2, async (request, extra) => {
      try {
        ...
        if (!tool) {
          throw new McpError(ErrorCode2.InvalidParams, `Tool ${request.params.name} not found`);
        }
        if (!tool.enabled) {
          throw new McpError(ErrorCode2.InvalidParams, `Tool ${request.params.name} disabled`);
        }
        const isTaskRequest = !!request.params.task;
        const taskSupport = tool.execution?.taskSupport;
        const isTaskHandler = "createTask" in tool.handler;
        if ((taskSupport === "required" || taskSupport === "optional") && !isTaskHandler) {
          throw new McpError(ErrorCode2.InternalError, `Tool ${request.params.name} has taskSupport '${taskSupport}' but was not registered with registerToolTask`);
        }
        if (taskSupport === "required" && !isTaskRequest) {
          throw new McpError(ErrorCode2.MethodNotFound, `Tool ${request.params.name} requires task augmentation (taskSupport: 'required')`);
        }
  ...
  async validateToolInput(tool, args, toolName) {
    ...
    if (!parseResult.success) {
      ...
      throw new McpError(ErrorCode2.InvalidParams, `Input validation error: Invalid arguments for tool ${toolName}: ${errorMessage}`);
    }
  ...
  async validateToolOutput(tool, result, toolName) {
    ...
    if (!result.structuredContent) {
      throw new McpError(ErrorCode2.InvalidParams, `Output validation error: Tool ${toolName} has an output schema but no structured content was provided`);
    }
    ...
    if (!parseResult.success) {
      const error = "error" in parseResult ? parseResult.error : "Unknown error";
      const errorMessage = getParseErrorMessage(error);
      throw new McpError(ErrorCode2.InvalidParams, `Output validation error: Invalid structured content for tool ${toolName}: ${errorMessage}`);
    }
  }
  /**
  ...
  async handleAutomaticTaskPolling(tool, request, extra) {
    ...
    while (task.status !== "completed" && task.status !== "failed" && task.status !== "cancelled") {
      ...
      if (!updatedTask) {
        throw new McpError(ErrorCode2.InternalError, `Task ${taskId} not found during polling`);
      }
      task = updatedTask;
    }
  ...
  setCompletionRequestHandler() {
    ...
    this.server.assertCanSetRequestHandler(getMethodValue(CompleteRequestSchema2));
    this.server.registerCapabilities({
      completions: {}
    });
    this.server.setRequestHandler(CompleteRequestSchema2, async (request) => {
      switch (request.params.ref.type) {
        ...
        default:
          throw new McpError(ErrorCode2.InvalidParams, `Invalid completion reference: ${request.params.ref}`);
      }
    });
  ...
  async handlePromptCompletion(request, ref) {
    ...
    if (!prompt) {
      throw new McpError(ErrorCode2.InvalidParams, `Prompt ${ref.name} not found`);
    }
    if (!prompt.enabled) {
      throw new McpError(ErrorCode2.InvalidParams, `Prompt ${ref.name} disabled`);
    }
  ...
  async handleResourceCompletion(request, ref) {
    ...
    if (!template) {
      ...
      throw new McpError(ErrorCode2.InvalidParams, `Resource template ${request.params.ref.uri} not found`);
    }
  ...
  setResourceRequestHandlers() {
    ...
    this.server.assertCanSetRequestHandler(getMethodValue(ListResourcesRequestSchema2));
    this.server.assertCanSetRequestHandler(getMethodValue(ListResourceTemplatesRequestSchema2));
    this.server.assertCanSetRequestHandler(getMethodValue(ReadResourceRequestSchema2));
    this.server.registerCapabilities({
      resources: {
        listChanged: true
      }
    });
    this.server.setRequestHandler(ListResourcesRequestSchema2, async (request, extra) => {
    ...
    this.server.setRequestHandler(ListResourceTemplatesRequestSchema2, async () => {
    ...
    this.server.setRequestHandler(ReadResourceRequestSchema2, async (request, extra) => {
      const uri2 = new URL(request.params.uri);
      const resource = this._registeredResources[uri2.toString()];
      if (resource) {
        if (!resource.enabled) {
          throw new McpError(ErrorCode2.InvalidParams, `Resource ${uri2} disabled`);
        }
      ...
      throw new McpError(ErrorCode2.InvalidParams, `Resource ${uri2} not found`);
    });
  ...
  setPromptRequestHandlers() {
    ...
    this.server.assertCanSetRequestHandler(getMethodValue(ListPromptsRequestSchema2));
    this.server.assertCanSetRequestHandler(getMethodValue(GetPromptRequestSchema2));
    this.server.registerCapabilities({
      prompts: {
        listChanged: true
      }
    });
    this.server.setRequestHandler(ListPromptsRequestSchema2, () => ({
    ...
    this.server.setRequestHandler(GetPromptRequestSchema2, async (request, extra) => {
      const prompt = this._registeredPrompts[request.params.name];
      if (!prompt) {
        throw new McpError(ErrorCode2.InvalidParams, `Prompt ${request.params.name} not found`);
      }
      if (!prompt.enabled) {
        throw new McpError(ErrorCode2.InvalidParams, `Prompt ${request.params.name} disabled`);
      }
      if (prompt.argsSchema) {
        ...
        if (!parseResult.success) {
          const error = "error" in parseResult ? parseResult.error : "Unknown error";
          const errorMessage = getParseErrorMessage(error);
          throw new McpError(ErrorCode2.InvalidParams, `Invalid arguments for prompt ${request.params.name}: ${errorMessage}`);
        }
...
function objectFromShape2(shape) {
  const values = Object.values(shape);
  if (values.length === 0) return object({});
  const allV4 = values.every(isZ4Schema2);
  const allV3 = values.every((s) => !isZ4Schema2(s));
  if (allV4) return object(shape);
  if (allV3) return z3rt3.object(shape);
  throw new Error("Mixed Zod versions detected in object shape.");
}
async function safeParseAsync4(schema, data) {
  if (isZ4Schema2(schema)) return await safeParseAsync(schema, data);
  return await schema.safeParseAsync(data);
}
function normalizeObjectSchema2(schema) {
  ...
  if (typeof schema === "object") {
    ...
    if (!asV3._def && !asV4._zod) {
      ...
      if (values.length > 0 && values.every(
        (value) => typeof value === "object" && value !== null && (value._def !== void 0 || value._zod !== void 0 || typeof value.parse === "function")
      )) {
        return objectFromShape2(schema);
      }
    }
  }
...
function getParseErrorMessage2(error) {
  if (error && typeof error === "object") {
...
function mapMiniTarget2(target) {
...
function toJsonSchemaCompat2(schema, opts) {
  if (isZ4Schema2(schema)) {
    return toJSONSchema(schema, {
      target: mapMiniTarget2(opts?.target),
      io: opts?.pipeStrategy ?? "input"
    });
  }
  return zodToJsonSchema(schema, {
...
var BrowserMcpServer = class extends McpServer {
  ...
  toTransportSchema(schema) {
    ...
    const normalized = normalizeObjectSchema2(schema);
    if (normalized) {
      return toJsonSchemaCompat2(normalized, {
        strictUnions: true,
        pipeStrategy: "input"
      });
    }
  ...
  syncNativeTools() {
    ...
    return this.backfillTools(
      ...
      async (name, args) => nativeCallTool({ name, arguments: args })
    );
  }
  unregisterTool(name) {
  ...
  async validateToolInput(tool, args, toolName) {
    ...
    if (this.isZodSchema(tool.inputSchema)) {
      const result2 = await safeParseAsync4(tool.inputSchema, args ?? {});
      if (!result2.success) {
        throw new Error(
          `Invalid arguments for tool ${toolName}: ${getParseErrorMessage2(result2.error)}`
        );
      }
      return result2.data;
    }
  ...
  async validateToolOutput(tool, result, toolName) {
    ...
    if (this.isZodSchema(tool.outputSchema)) {
      const parseResult = await safeParseAsync4(tool.outputSchema, response.structuredContent);
      if (!parseResult.success) {
        throw new Error(
          `Output validation error: Invalid structured content for tool ${toolName}: ${getParseErrorMessage2(parseResult.error)}`
        );
      }
      return;
    }
